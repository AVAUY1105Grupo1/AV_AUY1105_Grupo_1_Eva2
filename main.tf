module "networking" {
  source                = "git::https://github.com/AVAUY1105Grupo1/terraform-aws-vpc-auy1105-grupo-1.git?ref=main"
...
module "compute" {
  source                 = "git::https://github.com/AVAUY1105Grupo1/terraform-aws-ec2-auy1105-grupo-1.git?ref=main"
...
module "storage" {
  source                  = "git::https://github.com/AVAUY1105Grupo1/terraform-aws-s3-auy1105-grupo-1.git?ref=main"
